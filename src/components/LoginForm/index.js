...
// imported Cookies from js-cookie module
...
class LoginForm extends Component {
  ...
  onSubmitSuccess = jwtToken => {
    // storing the cookie in browser and setting time limit
    Cookies.set('Credentials', jwtToken, {expires: 1})
  ...
  render() {
    const jwtToken = Cookies.get('Credentials')
